		          ...
		          foreach($rfg as $row){
					  ?>
					   ...
					   <div class="col-sm-4">
									...
									<tr><td align=center style="height:160px"><a href="<?php echo base_url()."index.php/Welcome/sell_book/".$row->code?>"><img src="<?php echo base_url()?>././uploads/<?php echo $row->code?>.jpg" class="img-fluid"></a></td></tr>
									<tr><td> <b><?php echo $row->book_name?> </b></td> </tr>
 									<tr><td>₹<?php echo $row->book_amount?>(Fixed)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url()."index.php/Welcome/sell_book/".$row->code?>"><button class="btn btn-primary">View More</button></a></td></tr> 
									</table>
