  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	  ...
	  $(document).ready(function () {
			...
			$(".btn.btn-success").click(function(){
		      var cate= $("#category").val();
			   $.post(
			     "<?php echo base_url()."index.php/Admin/add_category"?>",{cate:cate},function(data){
					  if(data.trim()=="success"){
						  $("#record").html("<div class='alert alert-success'>Category Added</div>");
					  }
				 }
			   );
   ...
   $(document).on("click",".fa.fa-edit",function(){
	 ...
	 $(document).on("click",".fa.fa-save",function(){
                ...
                var msg = $("#f"+code).val();
                 $.post(
                  "<?php echo base_url()."index.php/Admin/update_category"?>",{code:code,msg:msg},function(data){
 					  if(data.trim()=="success"){
...
<div class="container-fluid">
    <div class="row">			
        <div class="col-sm-12 w3-card w3-blue">
		<div class="col-sm-12" id="record"></div>
           <div class="col-sm-12"><center><h2><strong>Dashboard</strong></h2></center></div>
                <label>Category:</label>
               <input type="text" id="category" class="form-control" placeholder="Add Your Category.."><br>
  ...
  <div class="row">
         <div class="col-sm-12 w3-card w3-white">
            <div class="col-sm-12"><center><h3><strong>Category Matches</strong></h3></center></div>
             <?php
			   $this->db->select("*");
			 ...
			 ?>
            <tr id="r<?php echo $row->code?>">
                <td id="d<?php echo $row->code?>"><strong><?php echo $row->category?></strong></td>
                 <td><i id="<?php echo $row->code?>"style="font-size:25px;color:blue;cursor:pointer;" class="fa fa-edit"></i></td>
                <td><i rel="<?php echo $row->code?>" style="font-size:25px;color:red;cursor:pointer;" class="fa fa-trash-o"></i></td>  
            </tr>
