   ...
   <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header"  >
        <img src="<?php echo base_url()?>assets/images/logo.jpg" width="120" height="70" class="logo" alt=""><center><h4 class="modal-title" >Login</h4></center>
...
<div class="modal" id="myModal1">
   <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header"  >
       <img src="<?php echo base_url()?>assets/images/logo.jpg" width="120" height="70" class="logo" alt=""> <h4 class="modal-title">Registration</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
...
<body>
    ...
    <div class="top-search">
        <div class="container">
            <div class="input-group">
                 <?php
				 echo form_open("Welcome/search_data");
    ...
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="m-b-40">When it comes to searching for books, there is only one place to turn to – Book Hub.</p>
            ...
            <li class="text-right">
                <img src="<?php echo base_url()?>assets/images/img1.webp" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Book Hub</strong></h1>
 ...
 <div class="container-fluid">
    <div class="row">
       <div class="col-sm-12"><center><h1><strong>All Books</strong></h1></center></div>
 	   <?php
			  ...
			  ?>
			    <div class="col-sm-12" style="background-color:white;">
                     <table class="table table-borderless w3-card" >
                         <tr ><td><?php echo $row->category?></td><td><a style="float:right;" href="<?php echo base_url()."index.php/Welcome/see_all_book/".$row->category?>">See All</a></td> </tr>
                     </table>
                 </div>
				...
				<div class="col-sm-4">
									<table class="table table-borderless w3-card">
									<tr><td align=center style="height:160px"> <img src="<?php echo base_url()?>././uploads/<?php echo $row1->code?>.jpg" class="img-fluid"></td></tr>
									<tr><td> <b><?php echo $row1->book_name?> </b></td> </tr>
 									<tr><td>₹<?php echo $row1->book_amount?>(Fixed)</td></tr> 
									</table>
                            ...
                            <div class="products-single fix">
                                <div class="box-img-hover">
                                    ...
                                    <div class="mask-icon">
                                        ...
                                        <a class="cart" href="#" data-toggle="modal" data-target="#myModal">Add to Cart</a>
                                    </div>
                                </div>
                                <div class="why-text">
