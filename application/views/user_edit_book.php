...
<div class="all-title-box">
     ...
     <div class="container-fluid">
	    <div class="row w3-card">
			   ...
			   <div class="col-sm-7">
 			      <?php
                 echo form_open("Welcome/update_book/".$row->code);
				 echo form_label("<strong>Book Quantity:</strong>");
				 $data = array("type"=>"text","name"=>"book_quantity","value"=>$row->book_quantity,"class"=>"form-control");
				...
				echo form_dropdown('category', $options, 'large',$js);
				 ...
				 $data = array("type"=>"text","name"=>"book_name","value"=>$row->book_name,"class"=>"form-control");
				 echo form_input($data);
				 echo "<br>";
				 echo form_label("<strong>Book Author:</strong>");
				 $data = array("type"=>"text","name"=>"book_author","value"=>$row->book_author,"class"=>"form-control");
				 echo form_input($data);
				 echo "<br>";
				 echo form_label("<strong>Book Edition:</strong>");
				 $data = array("type"=>"text","name"=>"book_edition","value"=>$row->book_edition,"class"=>"form-control");
				 echo form_input($data);
				 echo "<br>";
				 echo form_label("<strong>Book Amount:</strong>");
				 $data = array("type"=>"text","name"=>"book_amount","value"=>$row->book_amount,"class"=>"form-control");
				 echo form_input($data);
				 echo "<br>";
				 echo form_label("<strong>Book Description:</strong>");
				 $textarea_options = array('class' => 'form-control','rows' =>3,   'cols' =>5);
                 echo form_textarea('description',$row->description,  $textarea_options);
				 echo "<br>";
