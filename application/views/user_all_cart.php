		          ...
		          foreach($oop as $row){
					  ?>
					   ...
					   <div class="col-sm-4">
									...
									<tr><td align=center style="height:160px"><a href="<?php echo base_url()."index.php/Welcome/sell_book/".$row->book_code?>"><img src="<?php echo base_url()?>././uploads/<?php echo $row->book_code?>.jpg" class="img-fluid"></a></td></tr>
									<tr><td> <b><?php echo $row->book_name?> </b></td> </tr>
 									<tr><td>₹<?php echo $row->book_amount?>(Fixed)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url()."index.php/Welcome/sell_book/".$row->book_code?>"><button class="btn btn-primary">View More</button></a><a href="<?php echo base_url()."index.php/Welcome/cart_delete/".$row->code?>"><i style="float:right;font-size:25px;color:red;cursor:pointer;"class="fa fa-trash"></i></a></td></tr> 
									</table>
