...
<div class="all-title-box">
		  ...
		  <div class="col-sm-10 w3-card">
				...
				<table class="table table-borderless">
                   <tr>
					    ...
					    <td><a href="<?php echo base_url()."index.php/Welcome/Edit"?>"><i class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Edit Profile </a></td>
					 <td><a href="<?php echo base_url()."index.php/Welcome/user_profile"?>"><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp;Your Profile </a></td>
					 </tr>
                      <tr>
  ...
  <div class="row">
       <div class="col-sm-1"></div>
	   <div class="col-sm-10 w3-card">
	      <div class="col-sm-12"><strong><h3>Edit Your Profile</h3></strong></div><br><br>
 		  <?php
		        echo form_open("Welcome/Update");
				echo form_label("First Name:");
				$data = array("type"=>"text","name"=>"fname","value"=>$row->fname,"class"=>"form-control");
				echo form_input($data);
				echo "<br>";
				echo form_label("Last Name:");
				$data = array("type"=>"text","name"=>"lname","value"=>$row->lname,"class"=>"form-control");
				echo form_input($data);
				echo "<br>";
				echo form_label("Contact No:");
				$data = array("type"=>"text","name"=>"contact","value"=>$row->contact,"class"=>"form-control");
				echo form_input($data);
				echo "<br>";
				$data = array("type"=>"submit","value"=>"Save profile","class"=>"btn btn-success");
