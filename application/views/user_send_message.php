			     ...
			     foreach($spp as $row){
					 ?>
							   ...
							   <div class="col-sm-6"style="border-style: groove;">
					               <i style="font-size:80px;" class="fa fa-user-circle"></i>
							       <h5 style="cursor:pointer"><?php echo $row->name?></h5>
  								   <i class="fa fa-comment"></i><pre><?php echo $row->msg?></pre><br>
								   <i class="fa fa-phone"></i><?php echo $row->contact?><br><br>
                                    <a href="<?php echo base_url()."index.php/Welcome/reply/".$row->code?>"><i style="color:blue;font-size:20px;cursor:pointer;"class =" fa fa-reply"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url()."index.php/Welcome/delete_message/".$row->code?>"><i style="color:red;font-size:20px;cursor:pointer;" class="fa fa-trash"></i></a>								   
								   <h6 style="float:right;">Date: &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row->dt?></h6>
 							   </div>
							   <div class="col-sm-3"></div>
